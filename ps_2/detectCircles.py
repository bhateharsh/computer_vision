...
def detectCircles(im, radius, useGradient):
    ...
    # number of circles
    # nosBinsY = int((im.shape[0]+offset)/4)
    # nosBinsX = int((im.shape[1]+offset)/4)
    ...
    # number of circles
    # threshold = 0.7 # Setting thresholds to allow other bright circle
    # acc = gaussian(acc, sigma=1.5)
    # ***************************************************************
    threshold = 0.9
